...
public class ApiAddressController {
    ...
    @GetMapping("/{teamId}")
    public List<TeamInDomainRes> findAddress(@PathVariable("teamId") Long teamId) {
        return connectService.findTeamInDomain(teamId);
    }

    @GetMapping("/{teamId}/connects/{connectId}")
    public TeamInDomainPingRes connectionAddress(@PathVariable("teamId") Long teamId, @PathVariable Long connectId) {
